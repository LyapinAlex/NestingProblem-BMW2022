...
def greedy_alg(polygons, pallet_width, pallet_height, eps, drill_radius):
...
def main():
    ...
    if file_name == None:
        polygons = create_list_of_items(50, pallet_height, pallet_width, eps)
    else:
    ...
    items, work_time, height, width = greedy_alg(
